...
This folder is the region-default content layer for `reg45`.
...
- `regions/reg45/data/primary-assets.json`
- `regions/reg45/data/primary.json`
- `regions/reg45/data/footer.json`
- `regions/reg45/data/primaryending.json`
- `regions/reg45/assets/primary/manifest.json`
- `regions/reg45/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg45`.
